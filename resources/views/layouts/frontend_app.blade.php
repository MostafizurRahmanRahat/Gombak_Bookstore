                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <ul class="d-flex header-contact">
                            {{-- <li><i class="fa fa-phone"></i> +88-0171-489-50-74</li>
                            <li><i class="fa fa-envelope"></i> safzahidul.cse@gmail.com</li> --}}
                        </ul>
                    </div>
                    <div class="col-md-6 col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-8 col-sm-12">
                        <div class="footer-adress">
                            <ul>
                                <li><a href="#"><span>Email:</span> safzahidul@gmail.com</a></li>
                                <li><a href="#"><span>Tel:</span> +88-0171-489-50-74</a></li>
                                <li><a href="#"><span>Adress:</span> 32/C , East-Rampura , Dhaka</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="footer-reserved">
                            <ul>
                                <li>Copyright © 2020 E-Commerce All rights reserved Develop by Zij.</li>
                            </ul>
                        </div>
                    </div>
                </div>
